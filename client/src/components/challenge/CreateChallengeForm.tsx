  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                {field.value ? "Title from the selected recovery challenge" : "Select a challenge to see the title"}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                {field.value ? "Description from the selected recovery challenge" : "Select a challenge to see the description"}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        {/* Predefined Recovery Challenges */}
        <div className="border rounded-lg p-6 bg-primary/5 my-6">
          {form.getValues("matchId") ? (
            <PredefinedChallenges onChallengeSelected={handleAIChallengeSelect} />
          ) : (
            <div className="text-center py-8">
              <p className="text-neutral-600 italic">
                Please select a partner first to see available recovery challenges
              </p>
            </div>
          )}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 border-t pt-4 mt-4">
          <div className="text-sm text-neutral-500 italic">
            {form.getValues("title") ? (
              <span>Your selected recovery challenge is ready to create</span>
            ) : (
              <span>Please select a recovery challenge before continuing</span>
            )}
          </div>
          <Button 
            type="submit" 
